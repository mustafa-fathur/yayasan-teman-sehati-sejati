...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="text-center">
    ...
    <div class="mt-3">
      <p class="text-gray-500">We're part of the <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">Htmlstream</a> family.</p>
